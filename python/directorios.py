...
# Programa principal
#
description='Uso :%prog [options] directorio1 directorio2'
parser = OptionParser(usage=description)
parser.add_option('--size', action='store_true', dest='filtrarTamano', help='comprobar tamano de los ficheros')
parser.add_option('--md5', action='store_true', dest='filtrarMD5', help='comprobar hash md5 de los ficheros')
parser.add_option('--rm', action='store_true', dest='pedirBorrar', help='pedir borrado de ficheros')

args = parser.parse_args()
#carpetaTratar = args.directorio
filtrarTamano = args.filtrarTamano
filtrarMD5 = args.filtrarMD5
pedirBorrar = args.pedirBorrar
